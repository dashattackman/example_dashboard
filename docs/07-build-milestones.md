...
**Standing package — environment fidelity (also priority per Paul, lands with M2 and deepens each milestone):** believability over polycount. Real scanned CC0 surface textures (PolyHaven/ambientCG brick/asphalt/concrete/wood → KTX2 atlases + trim sheets) graded through the rim/ramp pipeline to stay graphic-novel; grime/wear/patch decals; dense street dressing (signage variety, wires, AC units, flyers, planters); window light-spill and interior-mapping tricks; haze/atmosphere depth; Minneapolis-specific set dressing. ART rubric gains a line: "does this street feel like a place that existed yesterday?"
