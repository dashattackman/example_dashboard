...
- **Main arc:** the Rogue Zone — glitched robotic enforcement units ("CIVIS", fictional contractor) holding the Lake Street corridor. Robots are guilt-free punching bags; the human stakes (who they flag/detain) are serious. Write it per the controversy contract in `01-vision.md`. Lore lives in `09-story-lore.md`.
